...
namespace PicOrganizer.Services
{
    ...
    public static class IEnumerableExtensions
    {
        ...
        public static Task ParallelForEachAsync<T>(this IEnumerable<T> source, Func<T, Task> funcBody, int maxDoP = 6)
        {
        ...
        public static Task ParallelForEachAsync<T1, T2>(this IEnumerable<T1> source, Func<T1, T2, Task> funcBody, T2 secondInput, int maxDoP = 6)
        {
        ...
        public static Task ParallelForEachAsync<T1, T2, T3>(this IEnumerable<T1> source, Func<T1, T2, T3, Task> funcBody, T2 secondInput, T3 thirdInput, int maxDoP = 6)
        {
            async Task AwaitPartition(IEnumerator<T1> partition)
            {
                using (partition)
        ...
        public static Task ParallelForEachAsync<T1, T2, T3, T4>(this IEnumerable<T1> source, Func<T1, T2, T3, T4, Task> funcBody, T2 secondInput, T3 thirdInput, T4 fourthInput, int maxDoP = 6)
        {
            async Task AwaitPartition(IEnumerator<T1> partition)
            {
                using (partition)
